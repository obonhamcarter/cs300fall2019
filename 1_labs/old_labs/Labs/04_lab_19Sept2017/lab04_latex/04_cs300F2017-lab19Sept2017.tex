...
Use the included source code written in Python (\emph{pythonCode/fastaReadWrite.py}). Use this code to load your FASTA file which you previously saved from Part1. 
\begin{itemize}
