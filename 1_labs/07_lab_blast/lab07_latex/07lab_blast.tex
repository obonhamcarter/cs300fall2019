...
\MYTITLE{Lab 7:\\ Investigating Potential Virulence Factors in \emph{E. coli}}
\MYHEADERS{}{\color{red} Due: 4$^{th}$ November \color{black}}{Handed out: 21$^{th}$ October 2019}
...
%\MYHEADERS{Introduction to Bioinformatics}{Due: 4$^{th}$ November (2 weeks).}{Handed out on: 21 October 2019}
...
\omitit{
\vspace*{-.1in}
\subsection*{Activity Steps: BLAST through BioPython}
\vspace*{-.1in} 
