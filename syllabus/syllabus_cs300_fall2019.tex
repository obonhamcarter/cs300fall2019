...
%The submission of assignments comprises the Honor Code pledge of the student(s) completing the work. For any assignment completed in a group, students must also turn in a one-page reflection that describes each group member's contribution to the submitted deliverables.  
  ...
  \item Late assignments will be accepted for up to one week past the assigned due date with a 15 percent penalty. After this late period, the labs will not be accepted and the student will receive a zero for missing work. All late assignments must be submitted within one week after the due date (i.e., during the late submission window). Unless special arrangements are made with the course instructor, no assignments will be accepted after the late deadline. 
\end{itemize}
}% end of omitit{}
